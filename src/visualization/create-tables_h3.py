...
cols = ['total_sleep_duration','awake_time','restless_sleep','pa_mean', 'pa_std',
        ...
        'min_prv_rmssd_ms', 'max_prv_rmssd_ms','resting'] 
network_mapping = {1: 'default mode',2: 'fronto parietal',3: 'cingulo operacular'}
