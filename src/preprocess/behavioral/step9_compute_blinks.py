...
# -*- coding: utf-8 -*-
"""
For full explanations, visit https://risoms.github.io/mdl/docs/build/manual/EyeLink%201000%20Plus%20User%20Manual%201.0.12.pdf
...
root_dir = '/m/cs/project/networks-pm/mri/fast_prepro_bids/'
    ...
    with open(file) as log:
        ...
        for index, line in enumerate(log):
            ...
            # blink
                ...
                end_time = time[3]
                dur = time[4]
                df = df.append({'SUBJECT': sb, 'TASK': task, 'EVENT': event, 'START_TIME': time, 'END_TIME': end_time,
                                'BLINK_DURATION': dur}, ignore_index=True)
        
        log.close()
        
        df.to_csv(f'{root_dir}/{sb}_task-{task}_device-eyetrack.csv')
