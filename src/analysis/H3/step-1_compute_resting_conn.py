"""
This script computes the averaged-ROI ts for the resting state data. It also performs 
the scrubbing, applies the Fisher transform, regresses the mean FD and saves the matrices. 
