...
for c=0:3
	% c is a number that goes from 0 to 3 to follow subjects0.m, subjects1.m, ...
	...
	Params.PublicParams.dataDescription=clabels{c+1}; % labels need to be from 1 to 4, so c is added +1
